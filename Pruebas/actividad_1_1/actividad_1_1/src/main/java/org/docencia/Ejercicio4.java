 ...
 * @date 3 Oct 2025
 * @class Un array de números mixtos enteros que es recorrido con un bucle for
 * que itera el numero de veces que elementos en el array haya. Distingue entre positivos
 * negativos, ceros e imprime el mayor. Ademas optimiza iterando una vez menos a elementos haya en el 
